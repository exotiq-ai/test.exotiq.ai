  ...
  <MobileSection className="bg-white dark:bg-dark-900">
    <MobileContainer>
      <div className="text-center mb-12 sm:mb-16">
        <div className="inline-flex items-center px-3 sm:px-4 py-2 bg-red-100 dark:bg-red-900/30 rounded-full text-red-700 dark:text-red-300 font-semibold text-xs sm:text-sm mb-4 sm:mb-6 animate-slide-up">
          <TrendingDown className="w-3 sm:w-4 h-3 sm:h-4 mr-2" />
          Tired of Spreadsheets and Lost Bookings?
        </div>
